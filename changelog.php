...
<body>
    <div class="container-fluid">
        <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="container">
                <div class="container">
                    <a class="navbar-brand" href="#">Felix Surveys Data Tool - Changelog</a>
                </div>
            </div>
        </div>
		...
		<div class="container">
		    ...
		    <h3>Changelog</h3>
				...
				<li>Added note about logging out.</li>
				<li>Changed bar chart to represent question options split into groups as a percentage of all responses (so matching the table).</li>
				<li>Bootstrap update</li>
                        </ul>
			<b class="text-muted">VERSION 1.3.1 (26/02/2013)</b>
			<ul>
			...
			<b class="text-muted">VERSION 1.3 (26/02/2013)</b>
			<ul>
			...
			<b class="text-muted">VERSION 1.0</b>
			<p>Initial release.</p>
		</div>
    </div>
</body>
