...
if(array_key_exists('interested', $_POST)) {
    ...
    if(!is_array($data)) {
        ...
        $myPicture->drawText(20, 60,$_POST['interested'][0].' for '.$_POST['filter']." option: ".$_POST['requested_group'],array("FontSize"=>21, 'R' => 255, 'G' => 255, 'B' => 255));
        ...
        $myPicture->drawText(20, 120,"Chart segments indicate: ".$_POST['interested'][0],array("FontSize"=>12));
