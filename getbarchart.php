    ...
    if(!is_array($data)) {
        ...
        foreach($data['groups'] as $group_option) {
            ...
            foreach($question_data['question_options'] as $field_opt) {
                ...
                $g_values[] = round(($question_data['grouped_question_responses'][$group_option][$field_opt]/$question_data['group_options'][$group_option])*100,2);
            }
            $MyData->addPoints($g_values,$group_option);
        }
        
        $MyData->setAxisName(0,"% of ".$_POST['interested'][0]." in ".$_POST['filter']." group"); 
        $MyData->addPoints($question_data['question_options'],"Labels"); 
        ...
        $myPicture->drawText(20, 980,"© Felix Imperial - www.felixonline.co.uk",array("FontSize"=>12));
        ...
        $myPicture->drawText(20, 130,$_POST['interested'][0].' along bottom',array("FontSize"=>12));
        $myPicture->drawText(20, 155,$_POST['filter'].' key:',array("FontSize"=>12));
