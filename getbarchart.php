...
if(array_key_exists('interested', $_POST)) {
	...
	foreach($question_data['group_options'] as $group_option => $group_count) {
        ...
        $MyData->setAxisName(0,col2name($_POST['filter'])." in ".col2name($_POST['interested'][0])." group as a percentage of all responses"); 
        ...
        $myPicture->drawText(20, 60,col2name($_POST['interested'][0]).' organised by '.col2name($_POST['filter']),array("FontSize"=>18, 'R' => 255, 'G' => 255, 'B' => 255));
        ...
        $myPicture->drawText(20, 980,"(c) Felix Imperial - www.felixonline.co.uk",array("FontSize"=>10));
        
        /* Draw the scale and the 1st chart */ 
        $myPicture->setGraphArea(400,100,1450,800);
        ...
        $myPicture->drawText(20, 130,col2name($_POST['filter']).' along bottom',array("FontSize"=>10));
        $myPicture->drawText(20, 155,col2name($_POST['interested'][0]).' key:',array("FontSize"=>10));
